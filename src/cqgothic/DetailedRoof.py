...
class DetailedRoof(FlatRoof):
    def __init__(self):
        ...
        self.wall_details_length:float = 20
        self.wall_details_inset:float = 3
        self.wall_details_depth:float = 5
        self.wall_details_pillar_depth:float = 6
        self.wall_arch_fillet:float = 2
        self.wall_details_space:float = 4

        self.roof_overflow:float = 0 #informational at this point, can probably go away
